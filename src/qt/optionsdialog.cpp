    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new DiosysUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->diosysAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Diosys."), QMessageBox::Ok);
