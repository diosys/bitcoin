...
#ifndef H_DIOSYS_SCRIPT
#define H_DIOSYS_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CDiosysAddress
 */
...
public:
    ...
    // Pre-version-0.6, Diosys always counted CHECKMULTISIGs
