...
unlocked to sign the Diosys-Qt.app bundle.
...
allowing somebody to distribute a Diosys-Qt.app or diosys-qt-setup.exe with a valid
...
that the diosys-qt.exe file inside the installer had not been tampered with.
